...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((ExpandableListView)this.view.findViewById(R.id.expandable_list_view)).setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            @Override
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                Category category = accounts.get(i).getCategories().get(i1);
                ((MainActivity)getActivity()).categoryFragmentCallback.setCategory(category);
                return true;
            }
        });
        return view;
